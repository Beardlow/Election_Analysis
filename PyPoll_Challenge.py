...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        #print(counties_dict) spot check
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_dict:
        ...
        county_counts = (
            f'{county_name}: {county_votes} ({county_vote_percentage:.1f}%)\n')
        print(county_counts)
    
         # 6e: Save the county votes to a text file.
        txt_file.write(county_counts)
    ...
    winning_county_summary=(
        ...
        f'Highest Turnout (n): {winning_county_votes}\n'
        f'Percentage of Total Votes: {winning_county_percentage:.1f}%\n'
        f'-------------------------\n')
